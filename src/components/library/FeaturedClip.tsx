...
export function FeaturedClip({ game, clip }: FeaturedClipProps) {
  ...
  return (
    <Card className="relative isolate mx-auto max-w-[3200px] overflow-hidden rounded-[clamp(1.5rem,2vw,2rem)] border-white/10 bg-black shadow-[0_28px_90px_rgba(0,0,0,.38)]">
      <GameArtwork
        title={game.title}
      ...
      <div className="relative grid min-h-[22rem] items-center gap-8 p-[clamp(1.5rem,3vw,5rem)] lg:min-h-[clamp(27rem,29vw,33rem)] lg:grid-cols-[minmax(18rem,.85fr)_minmax(28rem,1.15fr)] lg:gap-[clamp(2rem,4vw,6rem)]">
...
export function FeaturedClipSkeleton({ game }: { game: Game }) {
  ...
  return (
    <Card
      ...
      className="relative isolate mx-auto max-w-[3200px] overflow-hidden rounded-[clamp(1.5rem,2vw,2rem)] border-white/10 bg-black shadow-[0_28px_90px_rgba(0,0,0,.38)]"
    >
      <GameArtwork
        title={game.title}
        start={game.accentStart}
      ...
      <div className="relative grid min-h-[22rem] items-center gap-8 p-[clamp(1.5rem,3vw,5rem)] lg:min-h-[clamp(27rem,29vw,33rem)] lg:grid-cols-[minmax(18rem,.85fr)_minmax(28rem,1.15fr)] lg:gap-[clamp(2rem,4vw,6rem)]">
        ...
        <Skeleton className="mx-auto aspect-video w-full max-w-[clamp(40rem,48vw,64rem)] rounded-2xl border border-white/10 bg-white/[.07] lg:mx-0 lg:justify-self-end" />
      </div>
    </Card>
  );
}
